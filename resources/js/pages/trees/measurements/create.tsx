      ...
      <div className="flex h-full w-full flex-1 flex-col gap-4 rounded-xl p-4">
        <Card className="w-full">
          <CardHeader>
            ...
            <CardDescription>
              Add measurement data for {tree.tree_species?.name || 'this tree'}.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p className="max-w-xs">
                            Diameter at Breast Height (DBH) is measured at 1.3 meters above ground level.
                            You can enter either the diameter or circumference.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                ...
                <div className="flex flex-col space-y-2 sm:flex-row sm:space-x-4 sm:space-y-0 items-start">
                  <div className="w-full sm:w-2/3">
                    ...
                    {errors.trunk_diameter && (
                      <p className="mt-1 text-sm text-red-500">{errors.trunk_diameter}</p>
                    )}
                  </div>
                  <ToggleGroup
                    type="single"
                  ...
                  <Label htmlFor="height" className="text-base">
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p className="max-w-xs">
                            Enter the height of the tree in meters.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
              ...
              <div className="space-y-2">
                  ...
                  <Label htmlFor="inclination" className="text-base">
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p className="max-w-xs">
                            Enter the inclination of the tree in degrees (0-90).
                            0 means the tree is perfectly vertical, 90 means it's horizontal.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                ...
                {errors.inclination && (
                  <p className="mt-1 text-sm text-red-500">{errors.inclination}</p>
                )}
              </div>
