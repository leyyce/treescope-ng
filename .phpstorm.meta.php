...
'logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','magellan.schema','magellan.json_generator',
'magellan.sql_generator','magellan.string_generator','magellan.geodetic_srids','magellan.geodetic_default_srid','mail.default',
...
'trees.measurements.store','admin.dashboard','admin.users','admin.users.store','admin.users.update',
'admin.users.destroy','admin.roles','admin.roles.store','admin.roles.update','admin.roles.destroy',
'admin.permissions','admin.permissions.store','admin.permissions.update','admin.permissions.destroy','user.dashboard',
'user.map-view','storage.local',);
